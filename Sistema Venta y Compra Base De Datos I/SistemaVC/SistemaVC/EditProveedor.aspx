<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditProveedor.aspx.cs" Inherits="SistemaVC.EditProveedor" %>
           ...
           <table>
                 <tr>
                  <td style="font-family: 'Times New Roman', Times, serif; font-size: large">
                      <asp:Label runat="server" Text="Id Proveedor" ID="labelProveedorId" Visible="False" Font-Names="Times New Roman" Font-Size="Medium"></asp:Label>
                  </td>
                  <td>
             ...
             <tr>
                 <td class="auto-style2" style="font-family: 'Times New Roman', Times, serif; font-size: large">
                      <asp:Label runat="server" Text="Nombre Proveedor" ID="label1" Font-Names="Times New Roman" Font-Size="Medium" Font-Strikeout="False" Font-Underline="False"></asp:Label>
                 </td>
                 <td class="auto-style3">
                     <asp:TextBox runat="server" ID="txtNombre" Width="211px" Font-Names="Baskerville Old Face" Height="24px" Font-Size="Small"></asp:TextBox>
                      <ASP:RequiredFieldValidator id="rfvValidarNombre" runat="server" errormessage="El nombre es obligatorio" width="167px" controltovalidate="txtNombre" display="Dynamic" BorderColor="#006600" Height="23px" Font-Names="Times New Roman" Font-Size="Small"></ASP:RequiredFieldValidator>
                 </td>
             </tr>
             <tr>
                  <td class="auto-style4" style="font-family: 'Times New Roman', Times, serif; font-size: large">
              ...
              <tr>
                  <td class="auto-style5" style="font-family: 'Times New Roman', Times, serif; font-size: large">
              ...
              <tr>
                  <td class="auto-style7" style="font-family: 'Times New Roman', Times, serif; font-size: large">
