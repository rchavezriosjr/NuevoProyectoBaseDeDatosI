...
";
        ...
        public void ShowMessage(string mesagge)
        {
            ...
            Page.ClientScript.RegisterStartupScript(Page.GetType(), "Victor Sanchez", "showMessage('" + this.ClientID + "',0);", true);
            return;
        }
        /// <summary>
        ///  ShowMessage
        ...
        public void ShowMessage(string mesagge, paginaBase.MessageType type)
        {
            ...
            switch (type)
            {
                case paginaBase.MessageType.Error:
                    Page.ClientScript.RegisterStartupScript(Page.GetType(), "Sanchez", "showMessage('" + this.ClientID + "',0);", true);
