...
namespace SistemaVC
{
    public partial class AddProducto
    {
        public static int Insertar(Producto producto)
        {
            ...
            return Convert.ToInt32(DBHelper.ExecuteScalar("AddProducto_Insertar", dbParams));
        }
        ...
        public static DataSet GetTipoProductos()
        {
            ...
            return DBHelper.ExecuteDataSet("AddProducto_GetTipoProductos", dbParams);
        }
        ...
        public static DataSet GetTalles()
        {
            ...
            return DBHelper.ExecuteDataSet("AddProducto_GetTalles", dbParams);
        }
