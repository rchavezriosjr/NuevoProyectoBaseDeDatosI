<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListCliente.aspx.cs" Inherits="SistemaVC.ListCliente" %>
...
<html>
<head>
   <title>| Sistema SIVECOMP | Clientes |</title>
...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
	  ...
	  <td height="20" colspan="3" valign="top" style="background-color: #FFFFFF"  >&nbsp; <h2> Listado de Clientes</h2></td>
    </tr>
    <tr>
      ...
      <!--Contenido aqui-->
          ...
          <asp:GridView ID="gridClientes" runat="server" CssClass="subtitulo" EmptyDataText="No existen Registros" AutoGenerateColumns="False" OnRowCommand="gridClientes_RowCommand" CellPadding="4" ForeColor="Black" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px">
...
<HeaderStyle Width="100px"></HeaderStyle>
                   ...
                   <asp:TemplateField HeaderText="Acciones" HeaderStyle-Width="50px">
                      <ItemTemplate>
                          <asp:ImageButton runat="server" ID="btnEditar" AlternateText="Editar Cliente" ToolTip="Editar Cliente" CssClass="cBotones" ImageUrl="~/Imagenes/edit.png" CommandName="EditarCliente" CommandArgument='<%# Eval("Id") %>'/>
                          <asp:ImageButton runat="server" ID="btnEliminar" AlternateText="Eliminar Cliente" ToolTip="Eliminar Cliente" CssClass="cBotones" ImageUrl="~/Imagenes/eliminar.png"  CommandName="EliminarCliente" CommandArgument='<%# Eval("Id") %>'/>
                      </ItemTemplate>
