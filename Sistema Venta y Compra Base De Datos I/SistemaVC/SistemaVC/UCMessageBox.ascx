<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCMessageBox.ascx.cs" Inherits="SistemaVC.UCMessageBox" %>
<asp:Literal ID="scripts" runat="server"></asp:Literal>
 ...
 <div style="display:none">
  ...
  <div id="dialogError" title="Advertencia" runat="server" >
     <p>
