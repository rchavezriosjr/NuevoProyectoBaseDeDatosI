<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CambiarContra.aspx.cs" Inherits="SistemaVC.CambiarContra" %>
...
<html>
<head>
    <title>| Sistema SIVECOMP | Cambiar Contraseña |</title>
...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#ffffff">
    ...
    <tr>
      ...
      <!--Contenido aqui-->
          ...
          <asp:Image ID="Image1" runat="server" Height="376px" ImageUrl="Imagenes/pagina-en-construccion.png" style="margin-left: 12px" Width="761px" />
